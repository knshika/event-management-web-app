...
const HomePage = () => {
  return (
    <main className="min-h-screen flex w-full justify-center bg-gray-100  relative overflow-hidden ">
      <div className="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 m-auto rounded-3xl mt-5 w-3/4   relative z-20 items-center">
        <div className="container mx-auto px-6 flex flex-col justify-between items-center relative py-8">
          <div className="flex flex-col">
            ...
            <h2 className="font-light max-w-2xl mx-auto w-full text-xl dark:text-white text-gray-500 text-center py-8">
              Register your clubs to organize events in this event management
              web app and make it easy for students to participate.
            </h2>
            <div className="flex items-center justify-center mt-4">
              ...
              <a
                href="#"
                className="uppercase py-2 px-4 bg-transparent border-2 border-gray-800 rounded-lg text-gray-800 dark:text-white hover:bg-gray-800 hover:text-white text-base"
              >
                Features
              </a>
            </div>
...
// <div>
//   <h1>Welcome to your personal event manager of clubs events</h1>
// </div>
